...
Version  : 2.0.3
Release  : 51
URL      : https://files.pythonhosted.org/packages/26/83/2d67393cbb535b9ed7a7e42e944c255380f32835be6bcd86840f2c6f5b00/mistune-2.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/26/83/2d67393cbb535b9ed7a7e42e944c255380f32835be6bcd86840f2c6f5b00/mistune-2.0.3.tar.gz
...
%prep
%setup -q -n mistune-2.0.3
cd %{_builddir}/mistune-2.0.3
pushd ..
cp -a mistune-2.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656343264
...
cp %{_builddir}/mistune-2.0.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mistune/f763a35f662facb7d39a4fd7c3872b311855bc43
