...
Source0  : https://files.pythonhosted.org/packages/c6/1d/6b2b634e43bacc3239006e61800676aa6c41ac1836b2c57497ed27a7310b/mistune-3.1.1.tar.gz
...
%prep
%setup -q -n mistune-3.1.1
cd %{_builddir}/mistune-3.1.1
pushd ..
cp -a mistune-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738078443
