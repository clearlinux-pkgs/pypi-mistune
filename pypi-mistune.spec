...
Source0  : https://files.pythonhosted.org/packages/fb/6b/d8013058fcdb0088b4130164fc961e15c50d30302f60a349c16bdfda9770/mistune-2.0.5.tar.gz
...
%prep
%setup -q -n mistune-2.0.5
cd %{_builddir}/mistune-2.0.5
pushd ..
cp -a mistune-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675785269
