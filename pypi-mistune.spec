...
Source0  : https://files.pythonhosted.org/packages/80/f7/f6d06304c61c2a73213c0a4815280f70d985429cda26272f490e42119c1a/mistune-3.1.2.tar.gz
...
%prep
%setup -q -n mistune-3.1.2
cd %{_builddir}/mistune-3.1.2
pushd ..
cp -a mistune-3.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739976953
